...
namespace InControl
{
	public class XInputDevice : InputDevice
	{
		...
		{
			GamePad.SetVibration( (XInputDotNetPure.PlayerIndex) DeviceIndex, leftMotor, rightMotor );
		}


		void QueryState()
		{
			state = GamePad.GetState( (XInputDotNetPure.PlayerIndex) DeviceIndex, GamePadDeadZone.Circular );
		}
